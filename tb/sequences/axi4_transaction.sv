...
//                 - Represents one complete AXI4 burst (write or read)
//                 - Support randomizable fields: addr, len, burst type, data
//                 - Constraints suitable for the DUT (no AxSIZE, full-word only)
//
// Version       : 1.0
// Date          : 29-May-2026
//==============================================================================
...
constraint c_addr_alignment {
    axaddr[1:0] == 2'b00; // addr must be 4 byte aligned
}
